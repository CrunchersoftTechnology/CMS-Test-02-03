...
namespace CMS.Web.Controllers
{
    ...
    public class SchoolController : BaseController
    {
        ...
        public SchoolController(ISchoolService schoolService, ILogger logger, IRepository repository, IAspNetRoles aspNetRolesService, IEmailService emailService, IBranchAdminService branchAdminService, IClientAdminService clientAdminService)
        {
