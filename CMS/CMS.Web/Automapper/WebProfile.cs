    ...
    public class WebProfile : Profile
    {
        public WebProfile()
        {
           ...
           .ForMember(x => x.AppNotification, y => y.Ignore());
            ...
            CreateMap<ConfigureProjection, ConfigureViewModel>()
              .ForMember(dest => dest.ClientId, opts => opts.MapFrom(src => src.ClientId))
              .ForMember(dest => dest.name, opts => opts.MapFrom(src => src.name))
              .ForMember(dest => dest.ConfigureId, opts => opts.MapFrom(src => src.ConfigureId))
              .ForMember(dest => dest.aboutus, opts => opts.MapFrom(src => src.aboutus))
              .ForMember(dest => dest.address, opts => opts.MapFrom(src => src.address))
              .ForMember(dest => dest.email_id, opts => opts.MapFrom(src => src.email_id))
              .ForMember(dest => dest.password, opts => opts.MapFrom(src => src.password))
              .ForMember(dest => dest.sender_id, opts => opts.MapFrom(src => src.sender_id))
              .ForMember(dest => dest.username, opts => opts.MapFrom(src => src.username))
              .ForMember(dest => dest.CurrentUserRole, y => y.Ignore())
              .ForMember(x => x.Configure, y => y.Ignore());

            CreateMap<ConfigureProjection, ConfigureEditViewModel>()
              .ForMember(dest => dest.ClientId, opts => opts.MapFrom(src => src.ClientId))
              .ForMember(dest => dest.name, opts => opts.MapFrom(src => src.name))
              .ForMember(dest => dest.ConfigureId, opts => opts.MapFrom(src => src.ConfigureId))
              .ForMember(dest => dest.aboutus, opts => opts.MapFrom(src => src.aboutus))
            ...
            CreateMap<SchoolProjection, SchoolViewModel>()
               ...
               .ForMember(dest => dest.CurrentUserRole, opts => opts.MapFrom(src => src.CurrentUserRole))
               .ForMember(dest => dest.ClientId, opts => opts.MapFrom(src => src.ClientId))
               .ForMember(dest => dest.CurrentUserRole, y => y.Ignore())
               .ForMember(dest => dest.Name, opts => opts.MapFrom(src => src.Name))
